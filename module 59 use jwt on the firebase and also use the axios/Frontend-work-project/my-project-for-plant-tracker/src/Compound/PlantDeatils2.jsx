                ...
                <div className="bg-white rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-2xl shadow-emerald-900/5 border border-emerald-50 flex flex-col lg:flex-row min-h-[600px]">
                    ...
                    <div className="lg:w-1/2 p-8 md:p-12 flex flex-col justify-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <Link to={`/update/${plant._id}`}>  <button className="btn btn-outline border-emerald-200 text-emerald-800 hover:bg-emerald-50 hover:border-emerald-400 h-14 rounded-2xl px-8 font-bold">
                                Update
                            </button></Link>

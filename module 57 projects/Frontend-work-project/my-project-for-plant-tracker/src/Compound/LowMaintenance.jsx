...
const LowMaintenance = () => {
  const legends = [
    { name: "Snake Plant", tag: "The Survivor", desc: "Thrives on neglect and low light.", img: "https://images.unsplash.com/photo-1599598425947-02064789440e?auto=format&fit=crop&q=80&w=200" },
    ...
    { name: "ZZ Plant", tag: "The Indestructible", desc: "Needs water only once a month.", img: "https://images.unsplash.com/photo-1632203171982-cc0df6e9ceb4?auto=format&fit=crop&q=80&w=200" }
  ];

  return (
    <section className="py-20 px-4 bg-[#f3f9f1]">

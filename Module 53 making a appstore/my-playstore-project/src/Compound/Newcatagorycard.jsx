...
const Newcatagorycard = ({data}) => {
    return (
        <div className="card w-40 h-64 bg-base-300 hover:bg-base-200 shadow-xl overflow-hidden cursor-pointer hover:scale-105 transition-transform duration-300 hover:border border-primary">
            ...
            {/* Content Section */}
            <div className="card-body p-4 pt-8 text-white">
                ...
                <div className="flex items-center gap-4 mt-1 opacity-80">
                    ...
                    <div className="flex items-center text-primary  gap-1">
                        ...
                        <span className="text-sm text-white font-medium">20K</span>
                    </div>
                </div>
            </div>
        </div>
...
export default Newcatagorycard;